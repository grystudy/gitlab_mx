...
Gitlab::Application.routes.draw do
  ...
  # Project Area
  #
  resources :projects, constraints: { id: /[a-zA-Z.0-9_\-]+\/(?:(?!team_members)[a-zA-Z.0-9_\-\/])+/ }, except: [:new, :create, :index], path: "/" do
    member do
      put :transfer
      post :fork
      post :archive
    ...
    scope module: :projects do
      ...
      resources :releases, only: [:show], constraints: {id: /[a-zA-Z.0-9_\-]+/}
      ...
      resources :gitlab_services, constraints: { id: /[^\/]+/ }, only: [:index, :edit, :update], :controller=>"services" do
        member do
          get :test
        end
      end
