module API
  ...
  class Projects < Grape::API
    ...
    resource :projects do
      ...
      #
      # Parameters:
      #   namespace_path (required) - The name of a project who's format: NAMESPACE/PATH
      # Example Request:
      #   GET /projects/namespace_path
      get '*namespacepath' do
        present user_project_namespacepath, with: Entities::ProjectWithAccess, user: current_user
      end
